    ...
    {({ open }) => (
      <>
        <div className="mx-auto  px-2 ">
          ...
          <div className="absolute inset-y-0 right-0 flex px-10 items-center justify-between pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0 rounded-2xl w-[80%]  bg-[#181818]">
            {/* Search input */}
            <div className='w-96  '>
        ...
        <Disclosure.Panel className="sm:hidden">
          <div className="space-y-1 px-2 pb-3 pt-2 bg-[#212121] shadow-white">
          <div className='w-96'>
              <div className="flex items-center justify-between">
